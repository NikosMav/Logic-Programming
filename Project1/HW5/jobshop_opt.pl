...
jobshop_opt(Jobs, Staff, Schedule, Cost, Delta, Timeout) :-
  ...
  createMachineListOfLists(UpperBound, NumOfTypes, MachineListOfLists, 0),
  ...
  %Constraints
  stateConstraints(TaskListOfJobs, VariableList, StaffList, MachineListOfLists, AllTypesOfMachines, UpperBound),
  %Cost
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Variables%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Constraints%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stateConstraints([], [], _, _, _, _).
stateConstraints([TaskList|TaskLists], [VariableList|VariableLists], StaffList, MachineListOfLists, AllTypesOfMachines, UpperBound) :-
  Last #:: 0..UpperBound,
  taskSequence(TaskList, VariableList, Last),             %Task Sequence Constraint
  checkAvailStaff(StaffList, VariableList, TaskList),     %Staff Constraint
  machineAvailability(MachineListOfLists, VariableList, TaskList, AllTypesOfMachines),   %Machine Availability Constraint
  checkForMachineOverLap(VariableList, TaskList, AllTypesOfMachines),             %Machine Overlaps Constraint
  stateConstraints(TaskLists, VariableLists, StaffList, MachineListOfLists, AllTypesOfMachines, UpperBound).
...
checkForMachineOverLap(VariableList, TaskList, AllTypesOfMachines) :-
  flatten(VariableList, FlatVariableList),
